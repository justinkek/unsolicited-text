...
const registered: Record<string, string[]> = {"SessionStart":["load-rules.sh","mark-session-started.sh"],"UserPromptSubmit":["print-session-start-if-missed.sh","remind-response-length.sh","note-new-version.sh","replay-notes.sh"],"Stop":["note-long-reply.sh","note-long-queue.sh"]};

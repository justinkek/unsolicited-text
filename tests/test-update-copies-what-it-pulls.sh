...
named="$(grep --only-matching --extended-regexp '[a-z-]+\.sh' "$REPOSITORY/clients/claude-code-cloud/update.md" | sort --unique)"
...
home="$TMPDIR/home"
env HOME="$home" bash "$running/distributions/claude-code-cloud/install.sh"

...
1. Open 🔗 [claude.ai/code](https://claude.ai/code), open the environment settings, and find the Setup script field. 🔗 [The documentation](https://code.claude.com/docs/en/cloud-environments#setup-scripts) says where it is if the page has moved since.

...
## RELOAD.md, as it stands in this copy

This only applies where the plugin's hooks run. Check 🔗
[product compatibility](https://github.com/justinkek/unsolicited-text/blob/main/COMPATIBILITY.md) for your product and surface.
